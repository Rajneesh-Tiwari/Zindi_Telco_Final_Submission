...
```
telco_utils.py              # Parsing + classification library (robust header-based table parsers, all rules)
generate_traces_final.py    # Reasoning trace generation from train.csv (2,400 Type A)
train_sft_final.py          # Supervised fine-tuning (QLoRA on Qwen3-32B)
train_grpo_final.py         # GRPO reinforcement learning (3 reward functions)
...
**Models on HF Hub:**
- SFT: [Phaedrus33/SFT_final_submission](https://huggingface.co/Phaedrus33/SFT_final_submission)
- GRPO: [Phaedrus33/GRPO_final_submission](https://huggingface.co/Phaedrus33/GRPO_final_submission)
